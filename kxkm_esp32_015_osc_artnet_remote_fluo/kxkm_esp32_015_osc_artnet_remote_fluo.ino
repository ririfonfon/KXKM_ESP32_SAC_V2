...
void setup() {
  ...
  //////////////////////////////////////// ESP_SK_PW_FLUO ID ////////////////////////////////////
#ifdef ESP_SK_PW_FLUO
  eeprom_setID((byte)ESP_SK_PW_FLUO);
#endif

  // NAME
  myID = eeprom_getID();
  String myName("ESP_SK_PW_FLUO");
  sprintf(nodeName, "ESP_SK_PW_FLUO %02i %i", myID, VERSION);
#ifdef DEBUG
